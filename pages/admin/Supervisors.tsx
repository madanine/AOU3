          ...
          <div key={s.id} className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-xl transition-all">
            ...
            <div className="mt-4 pt-4 border-t border-gray-50 space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {s.supervisorPermissions?.attendance && <span className="px-2 py-1 bg-blue-50 text-blue-600 rounded-lg text-[10px] font-bold">{lang === 'AR' ? 'التحضير' : 'Attendance'}</span>}
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  >
                    ...
                    <span className="text-[10px] font-black uppercase">{lang === 'AR' ? 'التحضير' : 'Attendance'}</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => setFormData({
